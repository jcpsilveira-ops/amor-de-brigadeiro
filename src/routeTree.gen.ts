...
const CestaProducaoRoute = CestaProducaoRouteImport.update({
  id: '/cesta-producao',
  path: '/cesta-producao',
  getParentRoute: () => rootRouteImport,
} as any)
...
const ApiPublicChatgptRoute = ApiPublicChatgptRouteImport.update({
  id: '/api/public/chatgpt',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/cesta-producao': {
      id: '/cesta-producao'
      path: '/cesta-producao'
      fullPath: '/cesta-producao'
      preLoaderRoute: typeof CestaProducaoRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/clientes': {
      id: '/clientes'
